...
namespace DeviceManagementAPI.Services
{
    public class DeviceRepository : IDeviceRepository
    {
        ...
        public async Task<IEnumerable<Device>> GetAllDevicesAsync()
        {
            ...
            // ✅ Use alias since DB column is 'Name'
            const string query = "SELECT DeviceId, Name AS DeviceName, Description FROM Devices";
        ...
        public async Task<Device?> GetDeviceByIdAsync(int deviceId)
        {
            ...
            const string query = "SELECT DeviceId, Name AS DeviceName, Description FROM Devices WHERE DeviceId=@DeviceId";
            await using var cmd = new SqlCommand(query, con);
        ...
        public async Task<int> AddDeviceAsync(Device device)
        {
            ...
            await using var cmd = new SqlCommand(query, con);
            cmd.Parameters.Add("@Name", SqlDbType.NVarChar, 200).Value = device.DeviceName ?? (object)DBNull.Value;
